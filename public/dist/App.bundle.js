...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    if (isHearted) {
      ...
      setTimeout(function () {
        return _this.heat.classList.remove('heart__button--float');
      }, 2500);
    }
  }).catch(console.error);
}
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      ...
      //tell them nothing came back jabroni
      searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result">No results for ' + _this.value + ' found jabroni!</div>');
    }).catch(function (err) {
      console.log(err);
    });
  });
